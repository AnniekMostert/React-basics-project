...
export const Info = ({ recipe }) => {
  return (
    <SimpleGrid columns="2" columnGap="5px" gridTemplateColumns={{base: "1fr 125px", sm: "1fr 1fr"}}>
      <Text>Meal type: </Text>
      <Text fontWeight="bold" whiteSpace="pre-line">{recipe.mealType.length === 1
          ? recipe.mealType[0]
          : `${recipe.mealType[0]}\n${recipe.mealType[1]}`}</Text>
      <Text>Dish type:</Text>
